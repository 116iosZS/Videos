...
@interface MVSlidePopupView()<UIGestureRecognizerDelegate>
...
@implementation MVSlidePopupView


+ (instancetype)popupViewWithFrame:(CGRect)frame contentView:(UIView *)contentView {
    return [[MVSlidePopupView alloc] initWithFrame:frame contentView:contentView];
}
...
#pragma mark - MVSlidePopupViewContentProtocol
- (void)contentViewDismiss:(UIView*)contentView{
    [self dismiss];
}
@end
