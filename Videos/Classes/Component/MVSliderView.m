...
- (void)showLineLoading {
    [MVLineLoadingView showLoadingInView:self withLineHeight:self.gk_height];
}

- (void)hideLineLoading {
    [MVLineLoadingView hideLoadingInView:self];
}
